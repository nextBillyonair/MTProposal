...
\begin{figure}[ht]
    ...
    \begin{tabular}{ |l|r| }
        ...
        \multicolumn{1}{|c|}{Language} &
            \multicolumn{1}{|c|}{Subtitle Files} \\
        \hline
...
\begin{figure}[ht]
    ...
    \begin{tabular}{ |l|r| }
        \hline
        \multicolumn{1}{|c|}{Exact Language Pair} &
            \multicolumn{1}{|c|}{Aligned Sentences} \\ \hline
...
\begin{figure}[ht]
    ...
    \begin{tabular}{ |l|r| }
        \hline
        \multicolumn{1}{|c|}{Fuzzy Language Pair} &
            \multicolumn{1}{|c|}{Aligned Sentences} \\
        \hline
